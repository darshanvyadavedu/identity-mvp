...
-- =============================================================================
-- PROFESSION VERIFICATION (migration 001)
-- Apply via: backend/design/migrations/001_profession_verification.sql
-- =============================================================================
...
-- Non-sensitive evidence metadata only; document bytes are never stored.
